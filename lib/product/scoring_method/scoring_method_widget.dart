          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                      ...
                      Flexible(
                        child: Wrap(
                          ...
                          children: [
                            AutoSizeText(
                              FFLocalizations.of(context).getText(
                                'gesjt8gj' /* Lorem ipsum dolor sit amet, co... */,
                              ),
                ...
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 0.0, 29.0),
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '0v9l0jca' /* Your Guide to Health Scores */,
                              ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'dhiqoov1' /* Healthy choice(76-100)   */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                      ...
                      Flexible(
                        child: Wrap(
                          ...
                          children: [
                            AutoSizeText(
                              FFLocalizations.of(context).getText(
                                'cqbbguuu' /* Lorem ipsum dolor sit amet, co... */,
                              ),
                              textAlign: TextAlign.justify,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
