...
class ContinuePasswordWidget extends StatefulWidget {
  const ContinuePasswordWidget({
    super.key,
  ...
  static String routeName = 'ContinuePassword';
  static String routePath = '/continuePassword';

  @override
  State<ContinuePasswordWidget> createState() => _ContinuePasswordWidgetState();
}

class _ContinuePasswordWidgetState extends State<ContinuePasswordWidget>
    with RouteAware {
  late ContinuePasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContinuePasswordModel());
    ...
    _model.acceptSwitchValue = false;
  }
  ...
  @override
  void didUpdateWidget(ContinuePasswordWidget oldWidget) {
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'vg0xbsod' /* Now choose a password */,
                                  ),
                                ...
                                children: [
                                  Wrap(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'p6q6bvub' /* You are creating an account wi... */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
              ...
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: !_model.acceptSwitchValue!
                            ? null
                            : () async {
