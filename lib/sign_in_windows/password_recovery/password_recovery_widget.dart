...
class _PasswordRecoveryWidgetState extends State<PasswordRecoveryWidget>
  ...
  @override
  void didUpdateWidget(PasswordRecoveryWidget oldWidget) {
                    ...
                    Column(
                      ...
                      children: [
                              ...
                              children: [
                                TextSpan(
                                  text: FFLocalizations.of(context).getText(
                                    '6e8v1ttz' /* We send an email with a link t... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'xhnu7gl3' /* Remember to check the spam fol... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                  ...
                  children: [
                    Builder(
                      builder: (context) => InkWell(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'nxzoe4v2' /* I didn’t get an email. */,
                          ),
